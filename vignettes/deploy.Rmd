...
For subdomain, **ifnb** was added as a new domain to have a persistent URL. The image refers to DockerHub username and repo.

The app is available at [https://ifnb.serve.scilifelab.se/](https://ifnb.serve.scilifelab.se/).
