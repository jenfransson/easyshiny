...
#' @export
#' 
makeShinyCodes <- function(shiny.title, shiny.prefix, shiny.dir, enableSubset = TRUE, defPtSiz = 1.25, theme = "flatly", tabs = c(1, 2, 3, 4, 5, 6, 7), about = TRUE, font = "Lato", ganalytics = NA) {
